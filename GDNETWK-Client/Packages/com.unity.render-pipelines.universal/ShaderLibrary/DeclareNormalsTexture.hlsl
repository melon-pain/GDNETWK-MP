...
void SampleSceneNormals_float(float2 uv, out float3 normals)
{
...
void SampleSceneNormals_half(half2 uv, out half3 normals)
{
    half3 normal = SAMPLE_TEXTURE2D_X(_CameraNormalsTexture, sampler_CameraNormalsTexture, UnityStereoTransformScreenSpaceTex(uv)).xyz;
